...
const PixPagamento = () => {
  ...
  const now = new Date();
  const pixCode = `00020126580014br.gov.bcb.pix01368f1a2593-382d-4c82-9bd1-cb19348cf4ba520400005303986540${valor.toFixed(2)}5802BR5909PAGAMENTO6008SAOPAULO62110507${placa}6304`;
